...
public class JavaRGBImage {
	public int[] getImageGrayArray(BufferedImage img) {
	...
	public BufferedImage getBufferedImage(int width, int height, int[] grayArray) {
	...
	public int[][] oneDimToTwoDim(int width, int height, int[] oneDimArray) {
	...
	public int[] twoDimToOneDim(int width, int height, int[][] twoDimArray) {
